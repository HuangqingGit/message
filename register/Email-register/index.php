    ...
    <div id="main_content">
        ...
        <div id="form">
            <div class="in">
                ...
                <input id="userid" onkeydown="remove(event,'')" type="text" class="input_text" placeholder=" 请输入邮箱" maxlength="30" oninput="User_query()">
            </div>
            <div class="in">
                <div class="ic">
            ...
            <div class="in">
                <div class="ic">
                    ...
                    <span class="text_mesg pwd2_icon"></span>
                </div>
            ...
            <div class="in">
                ...
                <div class="yz">
                    <input id="auth" onkeydown="remove(event,'auth')" type="text" class="input_text" placeholder=" 请输入验证码" maxlength="6">
